...
const PHONE_DISPLAY = "+56 9 6895 7786";
...
const CONTACT_CARDS = [
  {
    ...
    label: "DIRECCIÓN",
    value: "Tierra Amarilla, Región de Atacama",
    color: "#35c8c1",
  },
  {
    icon: (
    ...
    <section id="contacto" className="section contact">
      ...
      <div className="contact__container">
        <div className="contact__header">
          ...
          <p className="contact__subtitle">Encuentranos en nuestra ubicacion.</p>
        </div>
        ...
        <div className="contact__content">
          <div className="contact__cards">
            {CONTACT_CARDS.map((card) => (
              <div key={card.label} className="contact-card">
                <div className="contact-card__icon" style={{ backgroundColor: card.color }}>
                  {card.icon}
                </div>
                <div className="contact-card__text">
                  <span className="contact-card__label">{card.label}</span>
                  {card.href ? (
                    <a href={card.href} target="_blank" rel="noopener noreferrer" className="contact-card__value contact-card__value--link">
                      {card.value}
                    </a>
                  ) : (
          ...
          <div className="contact__map-wrap">
            <div className="map-frame map-frame--gradient-border">
              <iframe
                title="Ubicación Estampados Damaris"
                src={MAP_EMBED_URL}
                width="600"
                height="450"
                style={{ border: 0 }}
